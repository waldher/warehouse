 ...
 */
(function(b,j){function k(a,c){var d=a.nodeName.toLowerCase();if("area"===d){d=a.parentNode;var e=d.name;if(!a.href||!e||d.nodeName.toLowerCase()!=="map")return false;d=b("img[usemap=#"+e+"]")[0];return!!d&&l(d)}return(/input|select|textarea|button|object/.test(d)?!a.disabled:"a"==d?a.href||c:c)&&l(a)}function l(a){return!b(a).parents().andSelf().filter(function(){return b.curCSS(this,"visibility")==="hidden"||b.expr.filters.hidden(this)}).length}b.ui=b.ui||{};if(!b.ui.version){b.extend(b.ui,{version:"1.9pre",
